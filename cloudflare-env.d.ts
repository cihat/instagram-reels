/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 11e3cee6ea11b331af3859de68c95b1a)
// Runtime types generated with workerd@1.20260317.1 2026-03-17 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		REELS_BUCKET: R2Bucket;
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* reels-search-next */;
	}
}
